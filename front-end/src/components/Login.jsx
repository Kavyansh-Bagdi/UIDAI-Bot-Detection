...
const Login = () => {
  ...
  return (
    ...
    <div className='w-full flex justify-center items-center '>
      <form action="" className='w-full mt-5 bg-white p-4 rounded-md'>
        ...
        <div className='gap-4 p-6 w-1/3 shadow-lg flex flex-col items-center justify-center h-56 mx-auto mt-5' style={{borderTop: '4px solid', borderImage: 'linear-gradient(to right, #020b50, #2C3A8F) 1'}}>
          <input type="text" placeholder='Enter your Aadhaar Number' className='w-full p-3 rounded-md text-xl  outline-none border-b-2 border-black -mt-9 mb-7'/>
